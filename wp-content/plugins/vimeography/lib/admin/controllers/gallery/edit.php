  ...
  public function vimeography_validate_basic_gallery_settings($input) {
    if (check_admin_referer('vimeography-basic-action','vimeography-basic-verification') ) {
      try {
        ...
        $input['vimeography_basic_settings']['video_limit'] = intval($input['vimeography_basic_settings']['video_limit']) <= 9999 ? $input['vimeography_basic_settings']['video_limit'] : 9999;
